...
const BASE_BTN =
  'flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[12px] font-mono border border-[#1e2040] text-[#8892b0] hover:bg-[#141428] hover:text-[#e8eaf6] hover:border-[#2a2d5a] transition-all duration-150 disabled:opacity-40 disabled:cursor-not-allowed';
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-[#080810] text-[#e8eaf6] font-sans">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {/* Center viewer */}
        <main className="flex flex-col flex-1 overflow-hidden bg-[#050508]">
          {/* Viewer toolbar */}
          <div className="flex items-center gap-1.5 px-4 py-2 bg-[#0c0c1a] border-b border-[#1e2040] flex-shrink-0 flex-wrap">

            {/* Run analysis */}
            <button
              disabled={!image || isAnalyzing}
              onClick={handleAnalyze}
              className="flex items-center gap-2 px-4 py-1.5 rounded-lg text-[13px] font-mono
            ...
            <div className="w-px h-4 bg-[#1e2040] mx-1" />
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[12px] font-mono border transition-all duration-150 disabled:opacity-40 disabled:cursor-not-allowed
            ...
            >
              ...
              {isLabeling
                ? 'Labeling...'
                : annotations.length > 0
                ? `Auto Labels (${annotations.length})`
                : 'Auto Labeling...'}
            </button>
            ...
            {/* Image metadata */}
            {image && (
              <div className="ml-auto flex items-center gap-2 text-[11px] font-mono text-[#4a5568]">
